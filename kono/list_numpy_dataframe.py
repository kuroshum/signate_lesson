...
d_array3 = np.append(d_array3, 30)
print("要素の追加後：", d_array1, d_array2, d_array3)
print("-------\n")
...
column1 = pd.Series(d_array1, name = d_array4[0])
column2 = pd.Series(d_array2, name = d_array4[1])
column3 = pd.Series(d_array3, name = d_array4[2])
