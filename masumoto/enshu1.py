...
# numpy_arrayの要素の追加
print("要素の追加前：",d_array1,d_array2,d_array4)
d_array1 = np.append(d_array1,'Wakayama Dai')
d_array2 = np.append(d_array2,180.2)
d_array4 = np.append(d_array4,30)
print("要素の追加後：",d_array1,d_array2,d_array4)
print("-------\n")
...
column3 = pd.Series(d_array4,name=d_array3[2])
...
print("age列のインデックス0番:",d_dataframe["age"][0],"\n")