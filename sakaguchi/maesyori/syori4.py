...
#-------------------------------------------------------------------------------------------------------------------
bank_df.loc[(bank_df['job']=='management')|(bank_df['job']=='tecnician')|(bank_df['job']=='blue-collar')|(bank_df['job']=='admin.')|(bank_df['job']=='sevices')|(bank_df['job']=='self-employed')|(bank_df['job']=='entrepreneur')|(bank_df['job']=='housemaid'),'job2'] = 'worker'
bank_df.head()
#-----------------------
#練習問題10
...
bank_df_concat = pd.get_dummies(bank_df['contact'])
...
tmp4 = pd.concat([tmp3,bank_df_concat],axis=1)
...
print(bank_df_new2.head())

bank_df_new.to_csv('bank_prep2.csv',index=False)
